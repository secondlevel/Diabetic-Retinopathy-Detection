...
if __name__ == "__main__":
    ...
    filepath = os.path.abspath(os.path.dirname(__file__))+"\model_weight\ResNet18_pretrained.rar"
    filepath_csv = os.path.abspath(os.path.dirname(__file__))+"\history_csv\ResNet18_pretrained.csv"
