...
if __name__ == "__main__":
    ...
    filepath = os.path.abspath(os.path.dirname(__file__))+"\model_weight\ResNet50_pretrained.rar"
    filepath_csv = os.path.abspath(os.path.dirname(__file__))+"\history_csv\ResNet50_pretrained.csv"
