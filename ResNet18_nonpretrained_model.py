...
if __name__ == "__main__":
    ...
    filepath = os.path.abspath(os.path.dirname(__file__))+"\model_weight\ResNet18_nonpretrained.rar"
    filepath_csv = os.path.abspath(os.path.dirname(__file__))+"\history_csv\ResNet18_nonpretrained.csv"
